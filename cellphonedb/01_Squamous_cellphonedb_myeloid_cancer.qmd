...
for(i in 1:nrow(Sample_cell_frequency)){
  ...
  dir.create(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/Sample",Sample_cell_frequency$Var1[i]))
  write_h5ad(anndata = adata_Full_list[[i]],filename=paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/Sample",Sample_cell_frequency$Var1[i],"/Sample",Sample_cell_frequency$Var1[i],".h5ad"))
a<-adata_Full_list[[i]]$obs[,c("index","genevector_l2")]
write.table(x = a,file = paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/Sample",Sample_cell_frequency$Var1[i],"/Sample",Sample_cell_frequency$Var1[i],".tsv"),quote = F,row.names = F,sep = "\t")
  }
```
...
```{r}
sample_dirs <- list.dirs("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer", recursive = F)
...
df_list <- lapply(seq_along(sample_dirs), function(i) {
  ...
  cell_counts <- table(read.table(file = file.path(samp_dir, glue("{sample_name}.tsv")), header = T, sep = "\t", comment.char = "")$genevector_l2) %>% 
    as.data.frame()
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/Heatmap_significant.pdf"))  
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/Heatmap_significant_no_cancer_cancer.pdf"))  
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/barplot_Myeloid_Cancer.pdf"))
p
dev.off()
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/dotplot.pdf"),width = 19,height = 90)
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/dotplot_present_all_patients.pdf"),width = 19,height = 30)
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/dotplot_present_5_patients.pdf"),width = 19,height = 30)
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/dotplot_patient_specific.pdf"),width = 19,height = 60)
...
# pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/dotplot_patient_specific.pdf"),width = 19,height = 90)
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/dotplot_ILRB_family.pdf"),width = 19,height = 10)
...
pdf(paste0("/work/shah/users/Mobina/Project_Squamous/Results/cellphonedb/cellphonedb_myeloid_cancer/dotplot_Cancer_Macrophages.pdf"),width = 19,height = 10)
